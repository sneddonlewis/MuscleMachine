...
docker exec -it docker-musclemachine-postgresql-1 /bin/bash

psql -U MuscleMachine
```
...
To build the final jar and optimize the MuscleMachine application for production, run:
