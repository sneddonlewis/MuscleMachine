...
import com.sneddsy.muscle.repository.WorkSetRepository;
...
class WorkSetResourceIT {
    ...
    private static final Double DEFAULT_BAND_RESISTANCE = 1D;
    private static final Double UPDATED_BAND_RESISTANCE = 2D;

    private static final Double DEFAULT_CABLE_RESISTANCE = 1D;
    private static final Double UPDATED_CABLE_RESISTANCE = 2D;

    private static final Double DEFAULT_FREE_WEIGHT_RESISTANCE = 1D;
    private static final Double UPDATED_FREE_WEIGHT_RESISTANCE = 2D;
