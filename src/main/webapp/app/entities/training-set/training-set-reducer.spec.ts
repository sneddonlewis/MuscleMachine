...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAININGSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAININGSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAININGSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAININGSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAININGSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAININGSET actions', async () => {
      const expectedActions = [
        {
