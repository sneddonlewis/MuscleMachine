  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="muscleMachineApp.exercise.home.createOrEditLabel" data-cy="ExerciseCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="exercise-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="exercise-name"
                name="name"
