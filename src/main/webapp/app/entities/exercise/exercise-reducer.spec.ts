...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './exercise.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXERCISE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXERCISE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXERCISE actions', async () => {
      const expectedActions = [
        {
