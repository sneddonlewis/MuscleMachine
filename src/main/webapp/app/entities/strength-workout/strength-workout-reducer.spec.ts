...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRENGTHWORKOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_STRENGTHWORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STRENGTHWORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STRENGTHWORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STRENGTHWORKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STRENGTHWORKOUT actions', async () => {
      const expectedActions = [
        {
