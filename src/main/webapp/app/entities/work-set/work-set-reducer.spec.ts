...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './work-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WORKSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_WORKSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WORKSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WORKSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WORKSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WORKSET actions', async () => {
      const expectedActions = [
        {
