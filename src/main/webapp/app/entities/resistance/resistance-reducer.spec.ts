...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESISTANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESISTANCE actions', async () => {
      const expectedActions = [
        {
