package com.sneddsy.musclemachine.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sneddsy.musclemachine.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sneddsy.musclemachine.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.sneddsy.musclemachine.domain.StrengthWorkout.class.getName() + ".workSets");
            createCache(cm, com.sneddsy.musclemachine.domain.WorkSet.class.getName());
